...
LoupFinderTrustRegion::LoupFinderTrustRegion(const System& sys,const IntervalVector& initial_box) :
	finder_abs_taylor(sys,true),initial_box(initial_box),f_goal(sys.goal) {
}
