...
#ifndef __IBEX_OPTIMIZER_05_CONFIG_
#define __IBEX_OPTIMIZER_05_CONFIG_
...
class Optimizer05Config : public OptimizerConfig, protected Memory {
public:

    Optimizer05Config(int argc, char** argv);
