...
Linearizer* Optimizer05Config::get_linear_relax() {
	...
	if (linearrelaxation=="art")
		ibex_error("[Optimizer05Config]: ART mode available only in ibex-affine package\n");
	else if (linearrelaxation=="compo")
		ibex_error("[Optimizer05Config]: COMPO mode available only in ibex-affine package\n");
